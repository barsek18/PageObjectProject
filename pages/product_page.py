...
class ProductPage(BasePage):
    ...
    def should_verificate_product_and_item_names(self):
        ...
        assert product_name == item_name, "Product name and item in the basket name are different"
    ...
    def should_verificate_product_and_item_price(self):
        ...
        assert product_price == item_price, "Product price and item in the basket price are different"
