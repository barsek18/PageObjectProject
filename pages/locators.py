...
class LoginPageLocators:
    ...
    REGISTRATION_USERNAME = (
        By.CSS_SELECTOR, "input#id_registration-email:required")
    REGISTRATION_PASSWORD = (
        By.CSS_SELECTOR, "input#id_registration-password1:required")
    REGISTRATION_PASSWORD_CONFIRMATION = (
        By.CSS_SELECTOR, "input#id_registration-password2:required")
